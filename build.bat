...
echo ==========================================
echo   Building NoesisSMP (Java 21)...
echo ==========================================
echo.

:: Locate a Java 21 JDK, matching pom.xml and the Minecraft 1.21 runtime.
set "FOUND_JDK="

:: 1. Check Eclipse Adoptium JDK 21 explicitly
...
:: 2. Fallback to standard Java JDK 21 if not found in Eclipse Adoptium
...
if defined FOUND_JDK (
    ...
    echo [WARNING] Java 21 JDK not found automatically. Using default system Java.
)
